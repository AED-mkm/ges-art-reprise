...
public class TypeRegltResource {
    ...
    @GetMapping("typeReglements/pageAll")
    public ResponseEntity<Page<TypeReglement>> allpage() {
        return new ResponseEntity<>(typeReglementService.findPage(0, 5, "createdDate"), HttpStatus.OK);
    }
}

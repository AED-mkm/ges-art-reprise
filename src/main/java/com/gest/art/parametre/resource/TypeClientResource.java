...
public class TypeClientResource {
    ...
    @GetMapping("typesclients/pageAll")
    public ResponseEntity<Page<TypeClient>> allpage() {
        return new ResponseEntity<>(typeClientService.findPage(0, 5, "createdDate"), HttpStatus.OK);
    }
}
